...
/**
 * REST controller for managing {@link com.urservices.domain.Administrateur}.
 */
@RestController
@RequestMapping("/api")
public class AdministrateurResource {
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PatchMapping(value = "/administrateurs/{id}", consumes = "application/merge-patch+json")
    public ResponseEntity<Administrateur> partialUpdateAdministrateur(
        ...
        Optional<Administrateur> result = administrateurService.partialUpdate(administrateur);
