...
@Component({
  selector: 'jhi-requete-semestriel',
  templateUrl: './requete-semestriel.component.html',
  styleUrls: ['./requete-semestriel.component.scss'],
})
export class RequeteSemestrielComponent implements OnInit {
  requetes?: IRequete[];
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.requeteService
      .queryByStudentByType(this.ins.id, 1, {
        page: pageToLoad - 1,
