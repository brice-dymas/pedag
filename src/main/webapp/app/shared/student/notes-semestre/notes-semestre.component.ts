...
@Component({
  selector: 'jhi-notes-semestre',
  templateUrl: './notes-semestre.component.html',
  styleUrls: ['./notes-semestre.component.scss'],
})
export class NotesSemestreComponent implements OnInit {
  notes?: INote[];
  isLoading = false;
  totalItems = 0;
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.noteService
      .queryByStudentAndTypeExam(this.ins.id, 1, {
        page: pageToLoad - 1,
