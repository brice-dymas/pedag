...
@Component({
  selector: 'jhi-notes-rattrapage',
  templateUrl: './notes-rattrapage.component.html',
  styleUrls: ['./notes-rattrapage.component.scss'],
})
export class NotesRattrapageComponent implements OnInit {
  notes?: INote[];
  isLoading = false;
  totalItems = 0;
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.noteService
      .queryByStudentAndTypeExam(this.ins.id, 2, {
        page: pageToLoad - 1,
