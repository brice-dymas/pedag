...
@Component({
  selector: 'jhi-requete-controle',
  templateUrl: './requete-controle.component.html',
  styleUrls: ['./requete-controle.component.scss'],
})
export class RequeteControleComponent implements OnInit {
  requetes?: IRequete[];
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    this.requeteService
      .queryByStudentByType(this.ins.id, 0, {
        page: pageToLoad - 1,
