...
describe('Component Tests', () => {
  describe('SessionExamen Management Component', () => {
    let comp: SessionExamenComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(SessionExamenComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.sessionExamen?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
