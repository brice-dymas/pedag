...
describe('Component Tests', () => {
  describe('Requete Management Component', () => {
    let comp: RequeteComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(RequeteComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.requetes?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
