...
export class DispenserComponent implements OnInit {
  ...
  delete(dispenser: IDispenser): void {
    const modalRef = this.modalService.open(DispenserDeleteDialogComponent, { size: 'lg', backdrop: 'static' });
    modalRef.componentInstance.dispenser = dispenser;
