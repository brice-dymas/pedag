...
describe('Component Tests', () => {
  describe('Dispenser Management Component', () => {
    let comp: DispenserComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(DispenserComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.dispensers?.[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
